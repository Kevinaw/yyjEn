...
class ContentController extends BaseController
{
	...
	public function successShowAction(Request $request, $alias)
	{
		$content = $this->getContentByAlias('success', $alias);
	...
	public function resourceShowAction(Request $request, $alias)
	{
		$content = $this->getContentByAlias('resource', $alias);
	...
	public function reviewShowAction(Request $request, $alias)
	{
		$content = $this->getContentByAlias('review', $alias);
